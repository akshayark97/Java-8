...
//		step3: create a method that prints all the people that have last name beginning with C
		...
		perfromConditionally(people, p -> p.getLastname().startsWith("C"),  p -> System.out.println(p));

		System.out.println("Print all person first name starts with C");
		perfromConditionally(people, p -> p.getFirstname().startsWith("C"),  p -> System.out.println(p.getFirstname()));
	}

//	Here I mention predicate method without using interface
//	TO-DO
